...
export interface ApiTipoPizzaTipoPizza extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    > &
      Schema.Attribute.Private;
    NombreTipo: Schema.Attribute.String & Schema.Attribute.Required;
    publishedAt: Schema.Attribute.DateTime;
    sabor_pizzas: Schema.Attribute.Relation<
      'oneToMany',
      'api::sabor-pizza.sabor-pizza'
    >;
    updatedAt: Schema.Attribute.DateTime;
